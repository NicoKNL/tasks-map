...
export default function UnlinkedTasksPanel({ tasks }: UnlinkedTasksPanelProps) {
  ...
  if (isCollapsed) {
    return (
      <div className="tasks-map-unlinked-panel tasks-map-unlinked-panel--collapsed">
        <button
          className="tasks-map-unlinked-panel__toggle"
          onClick={toggleCollapsed}
          title={t("unlinked_panel.expand")}
        >
  ...
  return (
    <div className="tasks-map-unlinked-panel">
      <div className="tasks-map-unlinked-panel__header">
        ...
        <button
          className="tasks-map-unlinked-panel__toggle"
          onClick={toggleCollapsed}
          title={t("unlinked_panel.collapse")}
        >
          <ChevronLeft size={16} />
        </button>
      </div>
